...
- News roundup videos from these channels are core content: a roundup that covers several real developments is a keep even when its title leads with a rumor or leak, because the roundup is the content and the speculation is a fraction of it. Educational explainers and concept tutorials are also core content, including from corporate channels (an explainer about managing AI risk is education, not marketing; a product demo or customer story is marketing). Drop a video only when the speculation, promotion, or drama IS the content: pure reaction videos, drama coverage, marketing without educational payload, and rumor videos with no underlying real event.
