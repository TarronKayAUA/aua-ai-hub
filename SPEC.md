...
- A community standards line (professional discussion; no patient information, student records, or exam content; content subject to moderation; linked to the AI Responsible Use Policy) appears above every comment box (`overrides/partials/comments.html`), in the Exchange page intro (pipeline-generated), and in the About page's Comments and feedback section. The wording is owner-drafted and pending committee ratification; edit in those three places to change it.
