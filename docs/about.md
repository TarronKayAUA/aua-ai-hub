...
4. **Weekly digest.** Every Friday a second selection pass picks the most significant items of the week, news, videos, and podcasts, into a digest feed for email distribution, with each week's digest preserved in the [News Archive](news/archive/index.md). The [This Week page](news/this-week.md) is separate: a rolling view of everything kept in the last seven days, refreshed nightly.
