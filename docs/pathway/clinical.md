...
??? question "After a memorable encounter, you want to explore the differential with a chatbot tonight. What makes the difference between fine and prohibited?"
    What you type in. A de-identified teaching abstraction (demographic band, presentation, findings pattern) is a legitimate study exercise. Anything identifiable, including unusual detail combinations that could point to a real person, makes it PHI in a public tool, which is prohibited regardless of your intent.
...
??? question "A resident on your rotation uses a phone app to transcribe patient conversations and asks you to do the same. What governs your answer?"
    The clinical site's policy on that specific tool, plus the university's rule that patient information requires an approved tool. Unless the site has sanctioned that app for patient encounters, recording into it is a privacy violation. The correct move is to check the site's policy or decline and ask your supervisor.
