...
- **Research and literature work**: the [AI for Research guide](tools/research.md) maps the licensed and free tools to each stage of the pipeline, Scopus first where it is strongest, and the [Research and Scholarship module](pathway/research.md) covers scholarly integrity, authorship, and disclosure.
