...
- [ ] Patient images and identifiable clinical photographs are governed by [The Rules](../pathway/rules.md). Licensed atlas figures are governed by their license and by the policy's [intellectual property section](../governance/policy.md#intellectual-property-rights-and-copyright-issues), whatever tool is involved.
