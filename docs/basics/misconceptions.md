...
<p class="hf-title">Calibrate trust by task, not by tone</p>
<div class="hf-panels">
<div class="hf-box hf-box--ok">
<p class="hf-box-title">Grounded in what you supplied</p>
<ul>
<li>summarizing your article</li>
<li>restructuring your notes</li>
<li>critiquing your draft</li>
</ul>
...
<li>dosages, criteria, thresholds</li>
<li>citations and references</li>
</ul>
<p class="hf-box-foot">Verify at the source before use.</p>
</div>
</div>
<p class="hf-note">The prose reads identically in both cases; the writing style tells you nothing.</p>
