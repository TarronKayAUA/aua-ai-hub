...
Share prompts that work for you and vote on what others have shared. Browse everything on the [Prompt Exchange page](exchange.md), updated from the discussion board several times a day. Posting and voting need a free [GitHub account](https://github.com/signup); reading needs no account. Community prompts that hold up in testing can be promoted into the library above, with credit to the contributor.
