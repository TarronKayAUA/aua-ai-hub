...
- **Generated text.** Machine-written summaries aim for plain language but are not individually reviewed for reading level.
- **Wide tables.** Benchmark and comparison tables scroll horizontally on narrow screens rather than reflowing.
